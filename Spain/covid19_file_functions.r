...
# COVID-19 daily data for Spain
# Comment lines depend on the analysis that you do want to do
# Analysis until march
input_covid19_data              <- paste0(INPUT_DATA_DIR, '/COVID-19-up-to-date-27-10-21_Spain_run_hasta_abril.csv')
# Analysis until july
# input_covid19_data              <- paste0(INPUT_DATA_DIR, '/COVID-19-up-to-date-27-10-21_Spain_run_hasta_julio.csv')
# Analysis until november
# input_covid19_data              <- paste0(INPUT_DATA_DIR, '/COVID-19-up-to-date-27-10-21_Spain_run_hasta_noviembre.csv')
